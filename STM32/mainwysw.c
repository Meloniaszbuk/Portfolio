...
/* USER CODE BEGIN PFP */
void ustaw_na_1(){
	HAL_GPIO_WritePin(GPIOC, SEG_A_Pin | SEG_B_Pin| SEG_C_Pin| SEG_D_Pin | SEG_E_Pin | SEG_F_Pin | SEG_G_Pin | SEG_DP_Pin, GPIO_PIN_SET);
}
...
void wyswietl(int liczba){
	...
	switch(liczba) {
		case 0:
		HAL_GPIO_WritePin(GPIOC, SEG_G_Pin, GPIO_PIN_RESET);
		break;
	case 1:
		HAL_GPIO_WritePin(GPIOC, SEG_A_Pin | SEG_D_Pin | SEG_E_Pin | SEG_F_Pin | SEG_G_Pin, GPIO_PIN_RESET);
		break;
	case 2:
		HAL_GPIO_WritePin(GPIOC, SEG_C_Pin | SEG_F_Pin, GPIO_PIN_RESET);
		break;
	case 3:
		HAL_GPIO_WritePin(GPIOC, SEG_E_Pin | SEG_F_Pin, GPIO_PIN_RESET);
		break;
	case 4:
		HAL_GPIO_WritePin(GPIOC, SEG_E_Pin | SEG_D_Pin | SEG_A_Pin, GPIO_PIN_RESET);
		break;
	case 5:
		HAL_GPIO_WritePin(GPIOC, SEG_B_Pin | SEG_E_Pin, GPIO_PIN_RESET);
		break;
	case 6:
		HAL_GPIO_WritePin(GPIOC, SEG_B_Pin, GPIO_PIN_RESET);
		break;
	case 7:
		HAL_GPIO_WritePin(GPIOC, SEG_E_Pin | SEG_F_Pin | SEG_G_Pin | SEG_D_Pin, GPIO_PIN_RESET);
		break;
	case 8:
		break;
	case 9:
		HAL_GPIO_WritePin(GPIOC, SEG_E_Pin, GPIO_PIN_RESET);
		break;
	}
}
